...
import { Edit, Trash2, Plus, Search, ChevronLeft, ChevronRight, ExternalLink } from "lucide-react";
...
const DemoBlogDashboard = () => {
  const navigate = useNavigate();
  const { posts, categories, deletePost } = useSeedData();
  ...
  return (
    ...
    >
      <Helmet>
        <title>Blog Dashboard Demo | Opportunity 4 All Talents</title>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          ...
          <Button onClick={() => navigate("/demo/dashboard/blog/new")} className="h-11">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            <button
                              type="button"
                              onClick={() => navigate(`/demo/dashboard/blog/edit/${post.id}`)}
...
export default DemoBlogDashboard;
