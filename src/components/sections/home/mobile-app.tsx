...
const MobileApp = () => {
  const features = [
    {
      title: "Player Profiles That Travel",
      description: "Give scouts and clubs a clear view of a player’s story, footage, position, and potential.",
    },
    {
      title: "Visibility With Context",
      description: "Present the person behind the performance with credible, focused storytelling.",
    },
  ];
      ...
      <Container className="flex flex-col md:flex-row justify-between md:gap-10 xl:gap-2xl gap-8">
        ...
        >
          ...
          <AnimateOnView
            ...
            className="md:mb-6 mb-3"
          >
            <p className="text-lg text-white">Football ability deserves context, visibility, and the right audience.</p>
          </AnimateOnView>
        ...
        >
          <img 
            ...
            src={globalPathway} 
            alt="Footballer entering a global stadium" 
            width="434"
            height="645"
            loading="lazy"
          />
