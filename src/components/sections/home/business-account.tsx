  ...
  const tabs = [
    {
      ...
      description: "Authentic integration through training, match preparation, equipment, or reviews.",
      lottie: revioPay,
      link: "/contact",
    },
    {
      ...
      description: "Partner-branded recognition featuring a player’s story and performance profile.",
      lottie: insights,
      link: "/contact",
    },
    {
      ...
      description: "Sponsored content on pathways, preparation, professionalism, and informed next steps.",
      lottie: sheild,
      link: "/contact",
    },
  ];
