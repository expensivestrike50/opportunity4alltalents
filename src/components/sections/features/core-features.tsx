...
const features = [
  {
    ...
    description: "A recurring video and social series profiling emerging players, presented by your brand.",
    image: grassrootsMatch,
  },
  {
    id: "multi-currency",
    title: "Product × Player",
    description: "Authentic product integration through training, match preparation, equipment, or honest player reviews.",
    image: trainingWide,
  },
  {
    id: "subscription-billing",
    title: "Player of the Month",
    description: "Partner-branded recognition featuring a player’s story, development, and performance profile.",
    image: scouting,
  },
  {
    id: "grassroots-access",
    title: "Grassroots Access",
    description: "Support for equipment, video capture, scouting showcases, and development events where talent begins.",
    image: grassrootsMatch,
  },
  {
    id: "football-education",
    title: "Football Education",
    description: "Sponsored content for players and parents on pathways, preparation, and professionalism.",
    image: mentorship,
  },
  {
    id: "dispute-chargeback",
    title: "Global Pathways",
    description: "Stories following talent from grassroots football toward academies, clubs, and professional environments.",
    image: mentorship,
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between md:gap-8 gap-4">
          <div className="flex-1 max-w-[683px]">
            <AnimateOnView once blur className="md:mb-4 mb-1.5">
              <Badge variant="default">Partnership Activation</Badge>
            </AnimateOnView>

            <AnimateOnView once blur delay={0.2}>
              <h2 className="h2">
                Turn sponsorship into stories and measurable value.
              </h2>
            </AnimateOnView>
          </div>
