                            ...
                            <CardContent className="p-0 flex flex-col flex-1 md:gap-10 sm:gap-8 gap-6">
                                <div>
                                    ...
                                    <p className="card-foreground md:mb-8 mb-6 flex-1">
                                        Our mission is simple: help emerging African football talent become visible to the scouts, clubs, partners, and pathways that can move careers forward. Talent is everywhere. Opportunity isn’t.
                                    </p>
